...
uint32_t blob_size_from_msgpack(const uint8_t *packed_value, uint32_t value_size);
void blob_from_msgpack(const uint8_t *packed_value, uint32_t value_size, as_particle **pp);
