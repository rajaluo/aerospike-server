...
{
	cf_crash(AS_RECORD, "as_record_vinfo_mask_get_lockfree() should be unreachable");
	return 0;
}
...
{
	cf_crash(AS_RECORD, "as_record_vinfo_mask_get() should be unreachable");
	return 0;
}
...
{
	cf_crash(AS_RECORD, "as_record_vinfoset_mask_get() should be unreachable");
	return 0;
}
...
{
	cf_crash(AS_RECORD, "as_record_vinfoset_mask_validate() should be unreachable");
	return false;
}
...
{
	cf_crash(AS_RECORD, "as_record_unused_version_get() should be unreachable");
	return 0;
}
...
{
	cf_crash(AS_RECORD, "as_record_merge() should be unreachable");
	return(0);
}
...
{
	cf_crash(AS_RECORD, "as_partition_vinfo_contains() should be unreachable");
	return false;
}
...
{
	cf_crash(AS_RECORD, "as_partition_vinfoset_contains_vinfoset() should be unreachable");
	return(false);
}
...
as_partition_vinfoset_superset_vinfoset(as_partition_vinfoset *vs1,
		as_partition_vinfo_mask mask1, as_partition_vinfoset *vs2)
{
	cf_crash(AS_RECORD, "as_partition_vinfoset_superset_vinfoset() should be unreachable");
	return false;
}
...
{
	cf_crash(AS_RECORD, "as_partition_vinfoset_pickle() should be unreachable");
	return(0);
}
...
{
	cf_crash(AS_RECORD, "as_partition_vinfoset_mask_pickle_getsz() should be unreachable");
	return(0);
}
...
{
	cf_crash(AS_RECORD, "as_partition_vinfoset_mask_unpickle() should be unreachable");
	return(0);
}
