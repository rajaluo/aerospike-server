...
as_info_init()
{
	...
	as_info_set_command("truncate", info_command_truncate, PERM_DELETE);                      // Truncate a namespace or set.
	as_info_set_command("truncate-undo", info_command_truncate_undo, PERM_DELETE);            // Undo a truncate command.
