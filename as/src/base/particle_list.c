...
uint32_t list_ptr(as_particle *p, uint8_t **p_value);
...
uint32_t list_mem_size(const as_particle *p);
uint32_t list_to_mem(const as_particle *p, uint8_t *value);
...
uint32_t
list_ptr(as_particle *p, uint8_t **p_value)
{
	// TODO
	return 0;
}
...
uint32_t
list_mem_size(const as_particle *p)
{
	// TODO
	return 0;
}
...
uint32_t
list_to_mem(const as_particle *p, uint8_t *value)
{
	// TODO
	return 0;
}
